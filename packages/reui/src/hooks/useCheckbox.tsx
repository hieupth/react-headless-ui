...
export const useCheckbox = (props: UseCheckboxProps = {}): UseCheckboxReturns => {
  ...
  return useMemo(() => ({
    ...
    ref: inputRef,
    inputValue
  }), [state, toggle, handleFocus, handleBlur, handleKeyDown, handleKeyUp, setChecked, setIndeterminate, focus, blur, semanticAttributes, className, focusableMixin.tabIndex, inputRef, inputValue]);
};