...
export const useInput = (props: UseInputProps = {}): UseInputReturns => {
  ...
  return useMemo(() => ({
    ...
    validationMessage,
    validity
  }), [state, handleChange, handleInput, handleFocus, handleBlur, handleKeyDown, handleKeyUp, setValue, clear, focus, blur, validate, reset, semanticAttributes, className, focusableMixin.tabIndex, inputRef, validationMessage, validity]);
};