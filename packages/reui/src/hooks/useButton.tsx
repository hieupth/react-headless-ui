...
export const useButton = (props: UseButtonProps = {}): UseButtonReturns => {
  ...
  return useMemo(() => ({
    ...
    handleClick,
    handleKeyDown,
    onFocus: focusableMixin.handleFocus,
    onBlur: focusableMixin.handleBlur,
    press: pressable.press,
    focus: focusableMixin.focus,
    blur: focusableMixin.blur,

    // Computed properties
    semanticAttributes,
    className,
    tabIndex: focusableMixin.tabIndex,
    ref: focusableMixin.focusRef
  }), [state, handleClick, handleKeyDown, focusableMixin.handleFocus, focusableMixin.handleBlur, pressable.press, focusableMixin.focus, focusableMixin.blur, focusableMixin.tabIndex, focusableMixin.focusRef, semanticAttributes, className]);
};