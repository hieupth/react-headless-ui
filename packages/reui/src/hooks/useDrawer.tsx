...
export interface DrawerState {
  ...
  /** Drawer variant */
  variant: string;
  /** Whether the drawer is modal (renders an overlay) */
  modal: boolean;
...
export function useDrawer(props: UseDrawerProps = {}) {
  ...
  const state = useMemo(() => ({
    ...
    closing,
    opening
  }), [isOpen, side, size, variant, modal, disabled, focusableMixin.focused, closing, opening]);
  ...
  const overlayAttributes = useMemo<React.HTMLAttributes<HTMLElement>>(() => ({
