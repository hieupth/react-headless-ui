...
export const useAvatar = (props: UseAvatarProps): UseAvatarReturns => {
  ...
  return useMemo(() => ({
    ...
    sizeClasses,
    fallbackText
  }), [state, handleImageError, handleImageLoad, handleClick, handleKeyDown, getFallbackText, getSizeClasses, semanticAttributes, avatarRef, imageRef, sizeClasses, fallbackText]);
};