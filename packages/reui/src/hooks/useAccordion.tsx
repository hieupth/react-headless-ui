...
export interface UseAccordionReturns extends UseAccordionState, UseAccordionActions {
  /** Items managed by the accordion */
  items: AccordionItem[];
  /** Get item state */
...
export const useAccordion = (props: UseAccordionProps): UseAccordionReturns => {
  ...
  return useMemo(() => ({
    ...
    // Computed properties
    semanticAttributes
  }), [state, items, toggleItem, openItem, closeItem, openAll, closeAll, handleKeyDown, focusNextItem, focusPreviousItem, focusFirstItem, focusLastItem, getItemState, getItemTriggerProps, getItemContentProps, semanticAttributes]);
};