...
export function useCommand(props: UseCommandProps = {}) {
  ...
  const semanticAttributes = useMemo<React.HTMLAttributes<HTMLElement> & { 'data-z-index'?: number }>(() => ({
    ...semantic,
  ...
  const searchInputAttributes = useMemo<React.InputHTMLAttributes<HTMLInputElement>>(() => ({
    type: 'text',
    placeholder,
    value: searchValue,
  ...
  const handlers = useMemo(() => ({
    ...
    handleBeforeOpen,
    handleBeforeClose
  }), [handleOpen, handleClose, handleToggle, handleSearch, handleKeyDown, handleSelect, handleItemFocus, handleBeforeOpen, handleBeforeClose]);
  ...
  return useMemo(() => ({
    ...
    listAttributes,
    getItemAttributes
  }), [state, handlers, semanticAttributes, searchInputAttributes, listAttributes, getItemAttributes]);
}