...
import { useAccessibleIcon, type UseAccessibleIconProps } from '@react-ui-forge/core';
import { useTheme } from '../providers/ThemeProvider';

export interface PortalProps extends Omit<UseAccessibleIconProps, 'iconRef'> {
  /** Portal content */
 ...
 */
export const Portal = forwardRef<HTMLElement, PortalProps>(({
  children,
  className = '',
  style,
  container,
