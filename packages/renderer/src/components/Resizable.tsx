...
import { useResizable, type UseResizableProps, type HandlePosition } from '@react-ui-forge/core';
  ...
  return (
    ...
    >
      ...
      <div className="sr-only" aria-live="polite">
        ...
        {!state.isResizing && state.activeHandle && `Resize stopped at ${Math.round(state.width)} by ${Math.round(state.height)} pixels`}
      </div>
    </div>
  );
});
