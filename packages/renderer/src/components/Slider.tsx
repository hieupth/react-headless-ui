...
import { useSlider } from '@react-ui-forge/core';
import type { UseSliderProps, SliderValue } from '@react-ui-forge/core';
    ...
    for (let i = 0; i < thumbCount; i++) {
      const thumbElement = renderThumb
        ? renderThumb({
            ...
            active: props.activeThumb === i,
            dragging: props.dragging && props.activeThumb === i,
            className: '',
            style: {},
