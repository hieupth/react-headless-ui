...
import { useCard } from '@react-ui-forge/core';
import type { UseCardProps } from '@react-ui-forge/core';
...
export const Card = forwardRef<HTMLDivElement, CardProps>(({
  ...
  const card = useCard({
    ...
    cardRef: ref as React.RefObject<HTMLDivElement>
  });
  ...
  const defaultRender = (props: CardRenderProps) => {
    ...
    return (
      <div
        ref={props.cardRef as React.RefObject<HTMLDivElement>}
