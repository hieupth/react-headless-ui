...
import { useDialog } from '@react-ui-forge/core';
import { Button } from './Button';
import type { UseDialogProps } from '@react-ui-forge/core';
...
export const Dialog = forwardRef<HTMLDivElement, DialogProps>(({
  ...
  const dialog = useDialog({
    ...
    dialogRef: ref as React.RefObject<HTMLDivElement>
  });
  ...
  const defaultContentRender = (props: DialogContentRenderProps) => {
    return (
      ...
      >
        ...
        {!footer && (dialog.onConfirm || dialog.onCancel) && (
