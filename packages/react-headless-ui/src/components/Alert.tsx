...
export const Alert = forwardRef<HTMLDivElement, AlertProps>(({
  ...
  // Default icon render function. The lib ships no CSS, so the severity icons
  // carry explicit width/height (mirroring the dismiss X) or they collapse to 0x0.
    ...
    return (
      ...
      >
        ...
        <div className="alert">
          ...
          {description && (
            <p className="alert" id={`${props.semanticAttributes.id || 'alert'}-description`}>
              {description}
            </p>
          )}
