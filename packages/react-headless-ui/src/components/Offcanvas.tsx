...
import { useOffcanvas, type UseOffcanvasProps } from '../hooks/index.js';
...
export const OffcanvasTrigger = forwardRef<HTMLButtonElement, {
  ...
  const variantStyles = {
    ...
    secondary: {
      // reason: `theme.colors?.gray + '100'` is always a truthy string (even
      // 'undefined100' when gray is absent), so the prior `|| '#f3f4f6'` fallback
      // arm was unreachable dead code and has been removed.
