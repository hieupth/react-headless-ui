...
export interface UseButtonGroupReturns {
  ...
  getButtonProps: (index: number, additionalProps?: Record<any, any>) => Record<string, any>;
...
export const useButtonGroup = (props: UseButtonGroupProps & {
  ...
  const getButtonProps = useCallback((index: number, additionalProps: Record<any, any> = {}) => {
