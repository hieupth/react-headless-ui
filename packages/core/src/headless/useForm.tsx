...
import { useForm as useReactHookForm, UseFormProps as RHFUseFormProps, UseFormReturn, FieldValues, SubmitHandler, SubmitErrorHandler } from 'react-hook-form';
 ...
 */
export interface UseFormProps<TFieldValues extends FieldValues = FieldValues> extends Omit<RHFUseFormProps<TFieldValues>, 'resolver'> {
  /** Whether form is disabled */
  disabled?: boolean;
  /** Whether form is loading */
  loading?: boolean;
