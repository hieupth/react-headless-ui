...
export interface UseStepperReturns {
  ...
  /** Get step attributes */
  getStepAttributes: (step: StepperStep, index: number) => {
    key: string;
  ...
  getStepButtonAttributes: (step: StepperStep, index: number) => {
    'aria-label': string;
...
export function useStepper(props: UseStepperProps): UseStepperReturns {
  ...
  const getStepAttributes = (step: StepperStep, index: number) => ({
    key: step.key,
  ...
  const getStepButtonAttributes = (step: StepperStep, index: number) => ({
