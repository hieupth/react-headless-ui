...
export interface NavigationMenuActions {
  ...
  /** Get parent item */
  getParentItem: (itemId: string) => NavigationMenuItem | undefined;
  /** Get submenu items */
...
export interface UseNavigationMenuProps {
  ...
  navigationMenuRef?: React.RefObject<HTMLElement>;
}
...
export function useNavigationMenu(props: UseNavigationMenuProps): UseNavigationMenuReturns {
  ...
  function findParentItem(items: NavigationMenuItem[], itemId: string, parent: NavigationMenuItem | null = null): NavigationMenuItem | undefined {
    for (const item of items) {
  ...
  const navigateNext = useCallback(() => {
    ...
    let nextItem = currentItems[nextIndex];
    ...
    while (nextItem && (nextItem.disabled || nextItem.type === 'separator')) {
      ...
      nextItem = nextIndex < currentItems.length ? currentItems[nextIndex] : null;
    }
  ...
  const getParentItem = useCallback((itemId: string): NavigationMenuItem | undefined => {
