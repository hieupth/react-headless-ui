...
import { Skeleton } from '@hieupth/react-headless-ui';
import { Demo } from '@/components/demo';
import { PropsTable } from '@/components/props-table';

// Skeleton is one of the few react-headless-ui components that applies inline theme styles,
    ...
    <div className="mx-auto max-w-3xl px-6 py-12 space-y-8">
      <header className="space-y-3">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          ...
          most react-headless-ui components it applies inline theme styles, so it renders
