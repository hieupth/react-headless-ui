...
import { SlideIn } from '@hieupth/react-headless-ui';
  ...
  return (
    <div className="docs-page">
      <header className="docs-header">
        <h1 className="docs-h1">SlideIn</h1>
        <p className="docs-lead">
          A directional slide animation backed by the headless{' '}
          <code className="docs-code">useSlideIn</code> hook and rendered
      ...
      <section className="docs-section">
        <h2 className="docs-h2">Slide in from below</h2>
...
>
  <span>Slide up</span>
      ...
      <section className="docs-section">
        <h2 className="docs-h2">Slide from the left</h2>
        <p className="docs-desc">
