  ...
  return (
    <div className="docs-page">
      <header className="docs-header">
        <h1 className="docs-h1">Slot</h1>
        <p className="docs-lead">
          A composition primitive backed by the headless{' '}
          <code className="docs-code">useSlot</code> hook. Instead of
      ...
      <section className="docs-section">
        <h2 className="docs-h2">Clone onto a child</h2>
...
>
  <button>I keep my own element</button>
      ...
      <section className="docs-section">
        <h2 className="docs-h2">Merge strategies</h2>
        <p className="docs-desc">
...
>
  <button type="button" onClick={() => console.log('child clicked')}>
    Both handlers fire
      ...
      <section className="docs-section">
        <h2 className="docs-h2">Wrapper mode</h2>
        <p className="docs-desc">
