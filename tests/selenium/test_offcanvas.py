...
class TestOffcanvas:
    """Test suite for Offcanvas component."""

    def test_offcanvas_functionality(self, driver, test_helper, assertions):
        """Test 1: Offcanvas Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("layout")

        # Look for offcanvas elements
        selectors = [
            f"[data-testid*='offcanvas']",
            f".offcanvas",
            f"[role*='offcanvas']"
        ]
    ...
    def test_offcanvas_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("layout")

        # Look for offcanvas elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='offcanvas'], .offcanvas")
    ...
    def test_offcanvas_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("layout")
    ...
    def test_offcanvas_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='offcanvas'], .offcanvas, button, [role='button']")
