...
class TestLabel:
    ...
    def test_label_functionality(self, driver, test_helper, assertions):
        """Test 1: Label Functionality"""
    ...
    def test_label_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("inputs")

        # Look for label elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='label'], .label")
    ...
    def test_label_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("inputs")
    ...
    def test_label_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='label'], .label, button, [role='button']")
