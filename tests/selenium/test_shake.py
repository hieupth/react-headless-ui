...
class TestShake:
    """Test suite for Shake component."""

    def test_shake_functionality(self, driver, test_helper, assertions):
        """Test 1: Shake Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("motion")

        # Look for shake elements
        selectors = [
            f"[data-testid*='shake']",
            f".shake",
            f"[role*='shake']"
    ...
    def test_shake_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("motion")

        # Look for shake elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='shake'], .shake")
    ...
    def test_shake_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("motion")
    ...
    def test_shake_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='shake'], .shake, button, [role='button']")
