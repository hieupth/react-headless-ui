...
class TestSortable:
    """Test suite for Sortable component."""

    def test_sortable_functionality(self, driver, test_helper, assertions):
        """Test 1: Sortable Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("inputs")

        # Look for sortable elements
        selectors = [
            f"[data-testid*='sortable']",
            f".sortable",
            f"[role*='sortable']"
        ]
    ...
    def test_sortable_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("inputs")

        # Look for sortable elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='sortable'], .sortable")
    ...
    def test_sortable_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("inputs")
    ...
    def test_sortable_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='sortable'], .sortable, button, [role='button']")
