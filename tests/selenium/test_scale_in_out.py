...
class TestScaleInOut:
    """Test suite for ScaleInOut component."""

    def test_scale_in_out_functionality(self, driver, test_helper, assertions):
        """Test 1: ScaleInOut Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("motion")

        # Look for scale_in_out elements
        selectors = [
            f"[data-testid*='scale_in_out']",
            f".scale_in_out",
            f"[role*='scaleinout']"
        ]
    ...
    def test_scale_in_out_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("motion")

        # Look for scale_in_out elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='scale_in_out'], .scale_in_out")
    ...
    def test_scale_in_out_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("motion")
    ...
    def test_scale_in_out_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='scale_in_out'], .scale_in_out, button, [role='button']")
