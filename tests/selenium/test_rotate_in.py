...
class TestRotateIn:
    """Test suite for RotateIn component."""

    def test_rotate_in_functionality(self, driver, test_helper, assertions):
        """Test 1: RotateIn Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("motion")

        # Look for rotate_in elements
        selectors = [
            f"[data-testid*='rotate_in']",
            f".rotate_in",
            f"[role*='rotatein']"
        ]
    ...
    def test_rotate_in_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("motion")

        # Look for rotate_in elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='rotate_in'], .rotate_in")
    ...
    def test_rotate_in_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("motion")
    ...
    def test_rotate_in_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='rotate_in'], .rotate_in, button, [role='button']")
