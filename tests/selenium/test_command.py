...
class TestCommand:
    """Test suite for Command component."""

    def test_command_functionality(self, driver, test_helper, assertions):
        """Test 1: Command Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("navigation")

        # Look for command elements
        selectors = [
            f"[data-testid*='command']",
            f".command",
            f"[role*='command']"
        ]
    ...
    def test_command_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("navigation")

        # Look for command elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='command'], .command")
    ...
    def test_command_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("navigation")
    ...
    def test_command_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='command'], .command, button, [role='button']")
