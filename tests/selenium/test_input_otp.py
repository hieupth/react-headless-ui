...
class TestInputOtp:
    """Test suite for InputOtp component."""

    def test_input_otp_functionality(self, driver, test_helper, assertions):
        """Test 1: InputOtp Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("inputs")

        # Look for input_otp elements
        selectors = [
            f"[data-testid*='input_otp']",
            f".input_otp",
            f"[role*='inputotp']"
        ]
    ...
    def test_input_otp_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("inputs")

        # Look for input_otp elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='input_otp'], .input_otp")
    ...
    def test_input_otp_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("inputs")
    ...
    def test_input_otp_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='input_otp'], .input_otp, button, [role='button']")
