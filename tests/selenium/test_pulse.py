...
class TestPulse:
    """Test suite for Pulse component."""

    def test_pulse_functionality(self, driver, test_helper, assertions):
        """Test 1: Pulse Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("motion")

        # Look for pulse elements
        selectors = [
            f"[data-testid*='pulse']",
            f".pulse",
            f"[role*='pulse']"
    ...
    def test_pulse_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("motion")

        # Look for pulse elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='pulse'], .pulse")
    ...
    def test_pulse_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("motion")
    ...
    def test_pulse_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='pulse'], .pulse, button, [role='button']")
