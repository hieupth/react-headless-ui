...
class TestCalendar:
    ...
    def test_calendar_functionality(self, driver, test_helper, assertions):
        """Test 1: Calendar Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("inputs")

        # Look for calendar elements
        selectors = [
            f"[data-testid*='calendar']",
            f".calendar",
            f"[role*='calendar']"
        ]
    ...
    def test_calendar_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("inputs")

        # Look for calendar elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='calendar'], .calendar")
    ...
    def test_calendar_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("inputs")
    ...
    def test_calendar_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='calendar'], .calendar, button, [role='button']")
