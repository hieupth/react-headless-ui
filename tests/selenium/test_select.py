...
class TestSelect:
    ...
    def test_select_functionality(self, driver, test_helper, assertions):
        """Test 1: Select Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("inputs")

        # Look for select elements
        selectors = [
            f"[data-testid*='select']",
            f".select",
            f"[role*='select']"
        ]
    ...
    def test_select_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("inputs")

        # Look for select elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='select'], .select")
    ...
    def test_select_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("inputs")
    ...
    def test_select_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='select'], .select, button, [role='button']")
