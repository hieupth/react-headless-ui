...
class TestMegaMenu:
    """Test suite for MegaMenu component."""

    def test_mega_menu_functionality(self, driver, test_helper, assertions):
        """Test 1: MegaMenu Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("navigation")

        # Look for mega_menu elements
        selectors = [
            f"[data-testid*='mega_menu']",
            f".mega_menu",
            f"[role*='megamenu']"
        ]
    ...
    def test_mega_menu_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("navigation")

        # Look for mega_menu elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='mega_menu'], .mega_menu")
    ...
    def test_mega_menu_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("navigation")
    ...
    def test_mega_menu_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='mega_menu'], .mega_menu, button, [role='button']")
