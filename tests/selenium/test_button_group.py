...
class TestButtonGroup:
    ...
    def test_button_group_functionality(self, driver, test_helper, assertions):
        """Test 1: ButtonGroup Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("buttons")

        # Look for button_group elements
        selectors = [
            f"[data-testid*='button_group']",
            f".button_group",
            f"[role*='buttongroup']"
        ]
    ...
    def test_button_group_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("buttons")

        # Look for button_group elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='button_group'], .button_group")
    ...
    def test_button_group_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("buttons")
    ...
    def test_button_group_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='button_group'], .button_group, button, [role='button']")
