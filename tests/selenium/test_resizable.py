...
class TestResizable:
    """Test suite for Resizable component."""

    def test_resizable_functionality(self, driver, test_helper, assertions):
        """Test 1: Resizable Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("layout")

        # Look for resizable elements
        selectors = [
            f"[data-testid*='resizable']",
            f".resizable",
            f"[role*='resizable']"
        ]
    ...
    def test_resizable_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("layout")

        # Look for resizable elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='resizable'], .resizable")
    ...
    def test_resizable_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("layout")
    ...
    def test_resizable_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='resizable'], .resizable, button, [role='button']")
