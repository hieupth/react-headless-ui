...
class TestContextMenu:
    """Test suite for ContextMenu component."""

    def test_context_menu_functionality(self, driver, test_helper, assertions):
        """Test 1: ContextMenu Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("navigation")

        # Look for context_menu elements
        selectors = [
            f"[data-testid*='context_menu']",
            f".context_menu",
            f"[role*='contextmenu']"
        ]
    ...
    def test_context_menu_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("navigation")

        # Look for context_menu elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='context_menu'], .context_menu")
    ...
    def test_context_menu_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("navigation")
    ...
    def test_context_menu_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='context_menu'], .context_menu, button, [role='button']")
