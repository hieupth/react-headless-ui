...
class TestHoverLift:
    """Test suite for HoverLift component."""

    def test_hover_lift_functionality(self, driver, test_helper, assertions):
        """Test 1: HoverLift Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("motion")

        # Look for hover_lift elements
        selectors = [
            f"[data-testid*='hover_lift']",
            f".hover_lift",
            f"[role*='hoverlift']"
        ]
    ...
    def test_hover_lift_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("motion")

        # Look for hover_lift elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='hover_lift'], .hover_lift")
    ...
    def test_hover_lift_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("motion")
    ...
    def test_hover_lift_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='hover_lift'], .hover_lift, button, [role='button']")
