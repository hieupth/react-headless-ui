...
class TestNavigationMenu:
    """Test suite for NavigationMenu component."""

    def test_navigation_menu_functionality(self, driver, test_helper, assertions):
        """Test 1: NavigationMenu Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("navigation")

        # Look for navigation_menu elements
        selectors = [
            f"[data-testid*='navigation_menu']",
            f".navigation_menu",
            f"[role*='navigationmenu']"
        ]
    ...
    def test_navigation_menu_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("navigation")

        # Look for navigation_menu elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='navigation_menu'], .navigation_menu")
    ...
    def test_navigation_menu_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("navigation")
    ...
    def test_navigation_menu_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='navigation_menu'], .navigation_menu, button, [role='button']")
