...
class TestAvatar:
    ...
    def test_avatar_functionality(self, driver, test_helper, assertions):
        """Test 1: Avatar Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("data-display")

        # Look for avatar elements
        selectors = [
            f"[data-testid*='avatar']",
            f".avatar",
            f"[role*='avatar']"
        ]
    ...
    def test_avatar_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("data-display")

        # Look for avatar elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='avatar'], .avatar")
    ...
    def test_avatar_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("data-display")
    ...
    def test_avatar_no_errors(self, driver, test_helper, assertions):
