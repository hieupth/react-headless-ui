...
class TestForm:
    ...
    def test_form_functionality(self, driver, test_helper, assertions):
    ...
    def test_form_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("inputs")

        # Look for form elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='form'], .form")
    ...
    def test_form_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("inputs")
    ...
    def test_form_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='form'], .form, button, [role='button']")
