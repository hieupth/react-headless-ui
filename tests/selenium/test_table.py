...
class TestTable:
    ...
    def test_table_functionality(self, driver, test_helper, assertions):
        """Test 1: Table Functionality"""
    ...
    def test_table_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("data-display")

        # Look for table elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='table'], .table")
    ...
    def test_table_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("data-display")
    ...
    def test_table_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='table'], .table, button, [role='button']")
