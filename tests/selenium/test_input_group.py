...
class TestInputGroup:
    """Test suite for InputGroup component."""

    def test_input_group_functionality(self, driver, test_helper, assertions):
        """Test 1: InputGroup Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("inputs")

        # Look for input_group elements
        selectors = [
            f"[data-testid*='input_group']",
            f".input_group",
            f"[role*='inputgroup']"
        ]
    ...
    def test_input_group_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("inputs")

        # Look for input_group elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='input_group'], .input_group")
    ...
    def test_input_group_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("inputs")
    ...
    def test_input_group_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='input_group'], .input_group, button, [role='button']")
