...
class TestChip:
    """Test suite for Chip component."""

    def test_chip_functionality(self, driver, test_helper, assertions):
        """Test 1: Chip Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("data-display")

        # Look for chip elements
        selectors = [
            f"[data-testid*='chip']",
            f".chip",
            f"[role*='chip']"
    ...
    def test_chip_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("data-display")

        # Look for chip elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='chip'], .chip")
    ...
    def test_chip_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("data-display")
    ...
    def test_chip_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='chip'], .chip, button, [role='button']")
