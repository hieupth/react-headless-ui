...
"""
AccessibleIcon Component Tests
...
class TestAccessibleIcon:
    """Test suite for AccessibleIcon component."""

    def test_accessible_icon_functionality(self, driver, test_helper, assertions):
        """Test 1: AccessibleIcon Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("utilities")

        # Look for accessible_icon elements
        selectors = [
            f"[data-testid*='accessible_icon']",
            f".accessible_icon",
            f"[role*='accessibleicon']"
        ]
    ...
    def test_accessible_icon_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("utilities")

        # Look for accessible_icon elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='accessible_icon'], .accessible_icon")
    ...
    def test_accessible_icon_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("utilities")
    ...
    def test_accessible_icon_no_errors(self, driver, test_helper, assertions):
