...
"""
RevealOnScroll Component Tests
...
class TestRevealOnScroll:
    """Test suite for RevealOnScroll component."""

    def test_reveal_on_scroll_functionality(self, driver, test_helper, assertions):
        """Test 1: RevealOnScroll Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("motion")

        # Look for reveal_on_scroll elements
        selectors = [
            f"[data-testid*='reveal_on_scroll']",
            f".reveal_on_scroll",
            f"[role*='revealonscroll']"
        ]
    ...
    def test_reveal_on_scroll_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("motion")

        # Look for reveal_on_scroll elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='reveal_on_scroll'], .reveal_on_scroll")
    ...
    def test_reveal_on_scroll_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("motion")
    ...
    def test_reveal_on_scroll_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='reveal_on_scroll'], .reveal_on_scroll, button, [role='button']")
