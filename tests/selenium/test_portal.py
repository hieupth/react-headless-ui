...
class TestPortal:
    ...
    def test_portal_functionality(self, driver, test_helper, assertions):
        """Test 1: Portal Functionality"""
        # Navigate to appropriate category page
        test_helper.navigate_to_category("utilities")

        # Look for portal elements
        selectors = [
            f"[data-testid*='portal']",
            f".portal",
            f"[role*='portal']"
        ]
    ...
    def test_portal_renders_normally(self, driver, test_helper, assertions):
        """Test 2: Visual Rendering"""
        test_helper.navigate_to_category("utilities")

        # Look for portal elements
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='portal'], .portal")
    ...
    def test_portal_navigation(self, driver, test_helper, assertions):
        """Test 3: Navigation"""
        test_helper.navigate_to_category("utilities")
    ...
    def test_portal_no_errors(self, driver, test_helper, assertions):
        ...
        elements = test_helper.driver.find_elements(By.CSS_SELECTOR,
            f"[data-testid*='portal'], .portal, button, [role='button']")
